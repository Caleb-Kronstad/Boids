...
def Normalize(vector): #np.linalg.norm too slooooww had to write my own :)
...
class Boid:
    ...
    def Flock(this, boids, flock_params = FlockParams()):
        ...
        for other in boids.values():
            ...
            dist = Normalize(other.pos-this.pos) #20 fps boost when I went from np.linalg.norm to this -- crazy
